...
2. Из https://github.com/neovim/neovim/releases берем AppImage 12 версии (запустите команду ниже)
```
wget https://github.com/neovim/neovim/releases/download/v0.12.4/nvim-linux-x86_64.appimage
```

3. Делаем файл запускаемым
```
...
4. Скопируйте содержимое файла `init.lua` в `~/.config/nvim/init.lua`.
5. Запустите `nvim`
